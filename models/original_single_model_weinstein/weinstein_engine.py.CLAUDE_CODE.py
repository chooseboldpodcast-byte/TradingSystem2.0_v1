...
"""
Core Weinstein Stage Analysis Engine
Implements the 4-stage classification system
"""
import pandas as pd
import numpy as np
...
class WeinsteinEngine:
    ...
    def detect_stage_2_breakout(
        ...
        if len(stage1_data) > 0:
            ...
            # Accept if within 5% of resistance and >= (breakouts often happen AT resistance)
